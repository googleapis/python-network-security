...
from google.cloud.network_security_v1.services.network_security import NetworkSecurityAsyncClient
...
from google.cloud.network_security_v1.services.network_security import transports
...
def test_network_security_client_client_options_from_dict():
    with mock.patch('google.cloud.network_security_v1.services.network_security.transports.NetworkSecurityGrpcTransport.__init__') as grpc_transport:
...
def test_list_authorization_policies_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = authorization_policy.ListAuthorizationPoliciesResponse.pb(return_value)
...
def test_list_authorization_policies_rest_required_fields(request_type=authorization_policy.ListAuthorizationPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_authorization_policies._get_unset_required_fields(jsonified_request)
...
def test_list_authorization_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_authorization_policies") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_list_authorization_policies") as pre:
        ...
        req.return_value._content = authorization_policy.ListAuthorizationPoliciesResponse.to_json(authorization_policy.ListAuthorizationPoliciesResponse())
        ...
        client.list_authorization_policies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_authorization_policies_rest_bad_request(transport: str = 'rest', request_type=authorization_policy.ListAuthorizationPoliciesRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_authorization_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/authorizationPolicies" % client.transport._host, args[1])
...
def test_get_authorization_policy_rest_required_fields(request_type=authorization_policy.GetAuthorizationPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_authorization_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_authorization_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_get_authorization_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = authorization_policy.AuthorizationPolicy.to_json(authorization_policy.AuthorizationPolicy())
        ...
        client.get_authorization_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_authorization_policy_rest_bad_request(transport: str = 'rest', request_type=authorization_policy.GetAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/authorizationPolicies/*}" % client.transport._host, args[1])
...
def test_create_authorization_policy_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["authorization_policy"] = {'name': 'name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'action': 1, 'rules': [{'sources': [{'principals': ['principals_value1', 'principals_value2'], 'ip_blocks': ['ip_blocks_value1', 'ip_blocks_value2']}], 'destinations': [{'hosts': ['hosts_value1', 'hosts_value2'], 'ports': [569, 570], 'methods': ['methods_value1', 'methods_value2'], 'http_header_match': {'regex_match': 'regex_match_value', 'header_name': 'header_name_value'}}]}]}
    request = request_type(**request_init)
...
def test_create_authorization_policy_rest_required_fields(request_type=gcn_authorization_policy.CreateAuthorizationPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_authorization_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_authorization_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("authorizationPolicyId", )) & set(("parent", "authorizationPolicyId", "authorizationPolicy", )))
...
def test_create_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_create_authorization_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_create_authorization_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_authorization_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_authorization_policy_rest_bad_request(transport: str = 'rest', request_type=gcn_authorization_policy.CreateAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_authorization_policy_rest_required_fields(request_type=gcn_authorization_policy.UpdateAuthorizationPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_authorization_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_update_authorization_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_update_authorization_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_authorization_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_authorization_policy_rest_bad_request(transport: str = 'rest', request_type=gcn_authorization_policy.UpdateAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{authorization_policy.name=projects/*/locations/*/authorizationPolicies/*}" % client.transport._host, args[1])
...
def test_delete_authorization_policy_rest_required_fields(request_type=authorization_policy.DeleteAuthorizationPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_authorization_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_delete_authorization_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_delete_authorization_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_authorization_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_authorization_policy_rest_bad_request(transport: str = 'rest', request_type=authorization_policy.DeleteAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_server_tls_policies_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = server_tls_policy.ListServerTlsPoliciesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_server_tls_policies_rest_required_fields(request_type=server_tls_policy.ListServerTlsPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_server_tls_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_server_tls_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_server_tls_policies") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_list_server_tls_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = server_tls_policy.ListServerTlsPoliciesResponse.to_json(server_tls_policy.ListServerTlsPoliciesResponse())
        ...
        client.list_server_tls_policies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_server_tls_policies_rest_bad_request(transport: str = 'rest', request_type=server_tls_policy.ListServerTlsPoliciesRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_server_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/serverTlsPolicies" % client.transport._host, args[1])
...
def test_get_server_tls_policy_rest_required_fields(request_type=server_tls_policy.GetServerTlsPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_server_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_server_tls_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_get_server_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = server_tls_policy.ServerTlsPolicy.to_json(server_tls_policy.ServerTlsPolicy())
        ...
        client.get_server_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_server_tls_policy_rest_bad_request(transport: str = 'rest', request_type=server_tls_policy.GetServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_server_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/serverTlsPolicies/*}" % client.transport._host, args[1])
...
def test_create_server_tls_policy_rest_required_fields(request_type=gcn_server_tls_policy.CreateServerTlsPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_server_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_server_tls_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("serverTlsPolicyId", )) & set(("parent", "serverTlsPolicyId", "serverTlsPolicy", )))
...
def test_create_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_create_server_tls_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_create_server_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_server_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_server_tls_policy_rest_bad_request(transport: str = 'rest', request_type=gcn_server_tls_policy.CreateServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_server_tls_policy_rest_required_fields(request_type=gcn_server_tls_policy.UpdateServerTlsPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_server_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_update_server_tls_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_update_server_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_server_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_server_tls_policy_rest_bad_request(transport: str = 'rest', request_type=gcn_server_tls_policy.UpdateServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_server_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{server_tls_policy.name=projects/*/locations/*/serverTlsPolicies/*}" % client.transport._host, args[1])
...
def test_delete_server_tls_policy_rest_required_fields(request_type=server_tls_policy.DeleteServerTlsPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_server_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_delete_server_tls_policy") as post, \
         mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_delete_server_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_server_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_server_tls_policy_rest_bad_request(transport: str = 'rest', request_type=server_tls_policy.DeleteServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_client_tls_policies_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = client_tls_policy.ListClientTlsPoliciesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_client_tls_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = client_tls_policy.ListClientTlsPoliciesResponse.to_json(client_tls_policy.ListClientTlsPoliciesResponse())
...
def test_list_client_tls_policies_rest_bad_request(transport: str = 'rest', request_type=client_tls_policy.ListClientTlsPoliciesRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_client_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/clientTlsPolicies" % client.transport._host, args[1])
...
def test_get_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = client_tls_policy.ClientTlsPolicy.to_json(client_tls_policy.ClientTlsPolicy())
...
def test_get_client_tls_policy_rest_bad_request(transport: str = 'rest', request_type=client_tls_policy.GetClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/clientTlsPolicies/*}" % client.transport._host, args[1])
...
def test_create_client_tls_policy_rest_bad_request(transport: str = 'rest', request_type=gcn_client_tls_policy.CreateClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_client_tls_policy_rest_bad_request(transport: str = 'rest', request_type=gcn_client_tls_policy.UpdateClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{client_tls_policy.name=projects/*/locations/*/clientTlsPolicies/*}" % client.transport._host, args[1])
...
def test_delete_client_tls_policy_rest_bad_request(transport: str = 'rest', request_type=client_tls_policy.DeleteClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_network_security_base_transport():
    ...
    with mock.patch('google.cloud.network_security_v1.services.network_security.transports.NetworkSecurityTransport.__init__') as Transport:
...
def test_network_security_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.network_security_v1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_security_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.network_security_v1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkSecurityTransport()
        adc.assert_called_once()
