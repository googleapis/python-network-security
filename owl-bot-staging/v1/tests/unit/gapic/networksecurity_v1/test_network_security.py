...
from google.cloud.networksecurity_v1.services.network_security import NetworkSecurityAsyncClient
from google.cloud.networksecurity_v1.services.network_security import NetworkSecurityClient
from google.cloud.networksecurity_v1.services.network_security import pagers
from google.cloud.networksecurity_v1.services.network_security import transports
from google.cloud.networksecurity_v1.types import authorization_policy
from google.cloud.networksecurity_v1.types import authorization_policy as gcn_authorization_policy
from google.cloud.networksecurity_v1.types import client_tls_policy
from google.cloud.networksecurity_v1.types import client_tls_policy as gcn_client_tls_policy
...
from google.cloud.networksecurity_v1.types import server_tls_policy as gcn_server_tls_policy
...
def test_network_security_client_client_options_from_dict():
    with mock.patch('google.cloud.networksecurity_v1.services.network_security.transports.NetworkSecurityGrpcTransport.__init__') as grpc_transport:
...
def test_network_security_base_transport():
    ...
    with mock.patch('google.cloud.networksecurity_v1.services.network_security.transports.NetworkSecurityTransport.__init__') as Transport:
...
def test_network_security_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.networksecurity_v1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_security_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.networksecurity_v1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkSecurityTransport()
        adc.assert_called_once()
