...
class ServerTlsPolicy(proto.Message):
    ...
    class MTLSPolicy(proto.Message):
        ...
        Attributes:
            client_validation_ca (Sequence[google.cloud.network_security_v1.types.ValidationCA]):
...
class ListServerTlsPoliciesResponse(proto.Message):
    ...
    Attributes:
        server_tls_policies (Sequence[google.cloud.network_security_v1.types.ServerTlsPolicy]):
