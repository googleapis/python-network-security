...
def test_update_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{authorization_policy.name=projects/*/locations/*/authorizationPolicies/*}" % client.transport._host, args[1])
...
def test_update_server_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{server_tls_policy.name=projects/*/locations/*/serverTlsPolicies/*}" % client.transport._host, args[1])
...
def test_update_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{client_tls_policy.name=projects/*/locations/*/clientTlsPolicies/*}" % client.transport._host, args[1])
